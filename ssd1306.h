...
extern void ssd1306_clear_lines(uint8_t cy, uint8_t cnt);
...
extern void ssd1306_text_xy(const char *stroka, uint8_t cx, uint8_t cy, bool inv);
extern void ssd1306_text(const char *stroka);
