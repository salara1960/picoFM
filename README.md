FM radio based on Raspberry Pi Pico + RDA5807 + UC1609C + NS8002 + KCX_BT_EMITTER + LY-K3-01 + EC11 encoder
...
* Устройство инициализирует некоторые интерфейсы микроконтроллера :
  - ADC : Chan0(GP26) и Chan1(GP27) аналогово-цифровой преобразователь
          (измеряет напряжение на аналоговых выходах джойстика/переключателя).
  - GPIO : подключены три светодиода : GP29 - секундный тик, GP4,GP5,GP6,GP7 (DC,RST,SCK,MOSI) - пины интерфейса
           GP15 - пин обслуживает кнопку джойстка/переключателя в режиме прерывания,
